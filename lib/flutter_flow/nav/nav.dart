...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/homeStudents',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'HomeStudents')
              : const HomeStudentsWidget(),
        ),
        FFRoute(
          name: 'editProfile',
          path: '/editProfile',
        ...
        FFRoute(
          ...
          path: '/generatedQrcode',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'generatedQrcode')
              : const GeneratedQrcodeWidget(),
        ),
        FFRoute(
          name: 'CreateAccount',
          path: '/createAccount',
